...
struct GraphicsData
{
    ...
    struct LoadSettings
    {
        ...
        Skin::Id skinId = Skin::Id::Classic;
    ...
    struct Data // Data for a particular visual quality
    {
        ...
        std::shared_ptr<Skin> skin[::Skin::total] {};
    ...
    std::shared_ptr<Data> visualQualityData[VisualQuality::total] {};
    ...
    struct RenderData // Data required for rendering a given map with a given visual quality, skin, and tileset
    {
        ...
        std::shared_ptr<std::vector<std::shared_ptr<ClassicGrp>>> classicImages = nullptr; // 999 images
...
public:
    ...
    void load(GraphicsData & scrDat, const GraphicsData::LoadSettings & loadSettings, ArchiveCluster & archiveCluster, ByteBuffer & fileData);
